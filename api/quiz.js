...
module.exports = async (req, res) => {
  ...
  try {
    const response = await fetch("https://gist.githubusercontent.com/Serethor/1d3a74a2d7604ea09135de1fbfee9b67/raw/cani.json");
    const tuttiICani = await response.json();
